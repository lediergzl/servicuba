...
def get_entitlements(current_user: User = Depends(get_current_user)):
    ...
    GRATIS: descubrir y contratar servicios; no publica necesidades ni servicios.
    BASE: profesional; publica 1 servicio por día.
    PREMIUM: profesional; publica hasta 10 servicios y anuncios/promoción.
    """
    ...
    return {
        ...
        "can_contact": True,
        "can_apply": True,
        "can_publish_need": is_professional,
        "can_publish_service": is_professional,
        ...
        "can_publish_ads": premium,
        "ads_daily_limit": PLAN_PREMIUM_ANUNCIOS_DIA if premium else 0,

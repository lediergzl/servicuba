...
def send_push_to_user(db: Session, user_id: UUID, title: str, body: str, url: str = "/"):
    ...
    usuario. Nunca lanza: un fallo de push no debe tumbar el flujo principal
    (crear tarea, enviar mensaje, etc.). Las suscripciones caducadas
    (404/410) se eliminan automáticamente."""
